...
function RecentlyViewed() {
    ...
    return (
        <Container>
            <div className="recentelyviewed-overall">
                <h5 className="section-title">RECENT VIEWED PRODUCTS</h5>
                        ...
                        <div>
                            <div className="card-overall">
                                ...
                                <div class="addtocartbtn">
                                    <Row>
                                        <Col md={8} sm={8} lg={8}  className="card-cart-btn">
                                            <p>ADD TO CART</p>
                                        </Col>
                                        <Col md={4} sm={4} lg={4} className="card-wislist-btn">
                                            <div >
